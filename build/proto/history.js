...
function DayGroup({
  ...
  const totalCl = entries.reduce((s, e) => {
    ...
    const cl = u.includes('l') && !u.includes('cl') && !u.includes('ml') ? q * 100 : u.includes('cl') ? q : u.includes('ml') ? q / 10 : q; // cocktail "1 verre" etc.
    return s + cl;
  }, 0);
  return /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, daysFr[d.getDay()].slice(0, 3).toLowerCase(), ". ", d.getDate(), " ", months[d.getMonth()], "."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: T.muted,
      letterSpacing: 0.6,
