...
const THEMES = {
  ...
  light: {
    bg:       'oklch(98% 0.006 85)',    // warm cream
    surface:  'oklch(100% 0 0)',        // pure white card
    surface2: 'oklch(96% 0.006 85)',    // tinted input
    surface3: 'oklch(93% 0.008 80)',    // raised chip
    ink:      'oklch(22% 0.012 55)',    // espresso ink
    ink2:     'oklch(38% 0.01 60)',
    muted:    'oklch(55% 0.008 65)',
    rule:     'oklch(90% 0.008 80)',
    accent:   'oklch(60% 0.15 50)',     // slightly deeper amber for contrast
...
const CAT = {
  'Bière':      { hue: 80,  c: 0.16, light_l: 55, dark_l: 72, bg_l: 32 },   // gold
  'Vin':        { hue: 15,  c: 0.18, light_l: 52, dark_l: 70, bg_l: 30 },   // bordeaux red
  'Spiritueux': { hue: 300, c: 0.14, light_l: 55, dark_l: 72, bg_l: 32 },   // magenta
  'Cocktail':   { hue: 180, c: 0.13, light_l: 48, dark_l: 72, bg_l: 32 },   // teal
  'Autre':      { hue: 240, c: 0.10, light_l: 52, dark_l: 70, bg_l: 30 },   // blue
};
...
function HomeBar() {
  return (
    <div style={{
      ...
      <div style={{
        width: 128, height: 5, borderRadius: 99, background: T.ink, opacity: 0.35,
      }}/>
    </div>
  );
}
