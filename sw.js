...
// Bump all three on every static-asset change. CACHE_NAME is the single
...
const CACHE_NAME = 'alconote-v3.27.0';
const STATIC_CACHE = 'alconote-static-v3.27.0';
const DYNAMIC_CACHE = 'alconote-dynamic-v3.27.0';
